...
public class TC_2_1_1_World {
 ...
 //public By cardInformation = By.xpath("/html/body/form/div/input[1]");
...
// public void cardInformation(String number){
//  driver.findElement(cardInformation).sendKeys(number);
// }
